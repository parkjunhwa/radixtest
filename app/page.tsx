            ...
            <Card title="Aspect Ratio">
              <div className="space-y-4">
                <div>
                  ...
                  <AspectRatio.Root ratio={16 / 9} className="overflow-hidden rounded-sm bg-linear-to-br from-blue-500 to-purple-600 shadow-lg">
                ...
                <div>
                  ...
                  <AspectRatio.Root ratio={1} className="overflow-hidden rounded-sm bg-linear-to-br from-pink-500 to-rose-600 shadow-lg">
                    <div className="flex h-full items-center justify-center">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <Checkbox.Root
                    ...
                    className="flex h-5 w-5 items-center justify-center rounded border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500 transition-colors"
                  >
                  ...
                  >
                    {["left", "center", "right"].map((value, index, array) => (
                      <ToggleGroup.Item
                        key={value}
                        value={value}
                        className={`h-[32px] border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 data-[state=on]:bg-blue-500 dark:data-[state=on]:bg-blue-600 data-[state=on]:text-white transition-colors text-gray-700 dark:text-gray-300 ${index === 0 ? "rounded-l-sm" : ""
                  ...
                  <ToggleGroup.Root type="multiple" className="flex gap-2">
                    {["bold", "italic", "underline"].map((value) => (
                      <ToggleGroup.Item
                        key={value}
                        value={value}
                        className="h-[32px] rounded-sm border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 data-[state=on]:bg-blue-500 dark:data-[state=on]:bg-blue-600 data-[state=on]:text-white transition-colors text-gray-700 dark:text-gray-300"
                      >
